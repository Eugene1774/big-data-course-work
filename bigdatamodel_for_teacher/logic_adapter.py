...
def _get_socratic_response_impl(
    ...
    api_key = _get_config_value("SILICONFLOW_API_KEY")
    ...
    base_url = _get_config_value("SILICONFLOW_BASE_URL", DEFAULT_SILICONFLOW_BASE_URL)
    model = _get_config_value("SILICONFLOW_MODEL", DEFAULT_SILICONFLOW_MODEL)
